...
Joined CBA's 18-month graduate program, rotating through teams working on retail banking infrastructure. Promoted to Software Engineer after 12 months 🎉
[[MORE]]

-   Modernised Kubernetes secret delivery by migrating from Secret Store CSI Driver to ESO, and secrets storage from AWS Secrets Manager to HashiCorp Vault — both completed via ArgoCD GitOps across production workloads without downtime.
