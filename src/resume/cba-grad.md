...
Joined CBA's 18-month graduate rotation program but chose to stay within the same platform team throughout, drawn by the depth of the infrastructure work. Promoted to Software Engineer after 12 months 🎉
[[MORE]]
...
-   Modernised Kubernetes secret delivery by migrating from Secret Store CSI Driver to ESO, and secrets storage from AWS Secrets Manager to HashiCorp Vault (ongoing) — both completed via ArgoCD GitOps across production workloads without downtime.
